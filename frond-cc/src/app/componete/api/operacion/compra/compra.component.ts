...
export class CompraComponent {
  ...
  async verificar() {
    ...
    if (this.saldomn < this.resultado) {
      Swal.fire({
        icon: 'warning',
        title: 'El MONTO SUPERA A LO QUE HAY EN BÓVEDA',
    ...
    const data = {
      monto: this.resultado,               // campo esperado por la nueva función
    ...
    <body>
      <div class="ticket">
        ...
        <div class="section">
          ...
          <strong>Operación:</strong> COMPRA<br />
  ...
  crearjson() {
    ...
    this.nombre = 'PÚBLICO EN GENERAL';
